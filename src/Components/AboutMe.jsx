...
export default function AboutMe() {
  return (
    <div>
      <section id="about">
        <div className="flex flex-row items-center justify-center gap-20 pt-10 max-sm:flex max-sm:flex-col max-sm:gap-1">
          <div className="flex flex-col justify-center items-center text-center border-none w-1/2 py-10 gap-6 max-sm:items-start">
            <div className="flex flex-col gap-4 max-sm:place-items-start">
              <h2 className="text-gray-900 text-3xl font-bold max-sm:text-left">
                About Me
              </h2>
              <div className="flex flex-row items-center gap-10 max-sm:flex-col max-sm:items-start max-sm:gap-1">
            ...
            <p className="w-fit leading-loose font-mono max-sm:text-left">
